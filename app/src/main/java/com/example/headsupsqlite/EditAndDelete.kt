...
class EditAndDelete : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btedit.setOnClickListener {
            dbhlr.update(name.text.toString(),taboo1.text.toString(),taboo2.text.toString(),taboo3.text.toString()
                ,Nname.text.toString(),Ntaboo1.text.toString(),Ntaboo2.text.toString(),Ntaboo3.text.toString())
            name.setText("")
            taboo1.setText("")
            taboo2.setText("")
            taboo3.setText("")
